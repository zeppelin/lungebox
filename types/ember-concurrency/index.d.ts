// https://github.com/NullVoxPopuli/emberclear/blob/5cb232c3030b9111f3999a9465ebc9127c0811f2/packages/frontend/types/ember-concurrency/index.d.ts
// Plus a few things marked as "Lungebox:"
...
declare module 'ember-concurrency/task' {
   ...
   * `TaskInstance`s.
   */
  // Lungebox: added default `void` type argument to `PerformReturn`
...
declare module 'ember-concurrency/task-instance' {
  ...
  export default class TaskInstance<Return = any> {
    ...
    // Lungebox: added type arguments to `Task`
    task: Task<any, Return>;
